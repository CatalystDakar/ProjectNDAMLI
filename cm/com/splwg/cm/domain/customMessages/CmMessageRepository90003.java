...
import com.splwg.cm.domain.customMessages.CmMessageRepository90000.Messages;
import com.splwg.shared.common.ServerMessage;

public class CmMessageRepository90003 extends AbstractMessageRepository {

	
	/**
	    * Message Category Number 90000
	    */
	    public static final int MESSAGE_CATEGORY = 90003;

	    private static CmMessageRepository90003 instance;

	    public CmMessageRepository90003() {
	        super(MESSAGE_CATEGORY);
	    }

	    private static CmMessageRepository90003 getCommonInstance() {
	        if (instance == null) {
	          instance = new CmMessageRepository90003();
	        }
	        return instance;
	    }
	    ...
	    * @return ServerMessage
	    */
	    public static ServerMessage MSG_2(String param1) {
	        MessageParameters params = new MessageParameters();
	        params.addRawString(param1);
	    ...
	    * @return ServerMessage
	    */
	    public static ServerMessage MSG_4(String param1, String param2) {
	        MessageParameters params = new MessageParameters();
	        params.addRawString(param1);
	        params.addRawString(param2);
	    ...
	    * @return ServerMessage
	    */
	    public static ServerMessage MSG_5() {
	        MessageParameters params = new MessageParameters();
	    ...
	    * @return ServerMessage
	    */
	    public static ServerMessage MSG_6(String param1) {
	        MessageParameters params = new MessageParameters();
	        params.addRawString(param1); 
	    ...
	    * @return ServerMessage
	    */
	    public static ServerMessage MSG_7(String param1) {
	        MessageParameters params = new MessageParameters();
	        params.addRawString(param1); 
	    ...
	    * @return ServerMessage
	    */
	    public static ServerMessage MSG_8(String param1) {
	        MessageParameters params = new MessageParameters();
	        params.addRawString(param1); 
	        return getCommonInstance().getMessage(Messages.MSG_8, params);
	    }
	    
	    public static ServerMessage MSG_9(String param1) {
	        MessageParameters params = new MessageParameters();
	        params.addRawString(param1); 
	        return getCommonInstance().getMessage(Messages.MSG_9, params);
	    }
	    ...
	    */
	    ...
	    public static class Messages {
	        ...
	        */
	        ...
	        /**
	         * Attention, il n’existe pas de compte ou le compte saisie n’a pas de Tax role associée 
	         */
